    ...
    public partial class MyFirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentInGroup", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentInGroup_Group_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentInGroup_User_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentInGroup_GroupId",
                table: "StudentInGroup",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentInGroup_StudentId",
                table: "StudentInGroup",
                column: "StudentId");
